...
print("Backend URL: https://journal-analytics-1.preview.emergentagent.com")
print("API Base: https://journal-analytics-1.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://journal-analytics-1.preview.emergentagent.com")
