...
print("Backend URL: https://auth-flow-master.preview.emergentagent.com")
print("API Base: https://auth-flow-master.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://auth-flow-master.preview.emergentagent.com")
