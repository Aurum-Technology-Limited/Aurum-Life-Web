...
print("Backend URL: https://emotional-os-1.preview.emergentagent.com")
print("API Base: https://emotional-os-1.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://emotional-os-1.preview.emergentagent.com")
