...
print("Backend URL: https://supa-data-explained.preview.emergentagent.com")
print("API Base: https://supa-data-explained.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://supa-data-explained.preview.emergentagent.com")
