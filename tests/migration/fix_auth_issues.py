...
print("Backend URL: https://smart-life-os.preview.emergentagent.com")
print("API Base: https://smart-life-os.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://smart-life-os.preview.emergentagent.com")
