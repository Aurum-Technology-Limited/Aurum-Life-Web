...
print("Backend URL: https://aurum-life-os.preview.emergentagent.com")
print("API Base: https://aurum-life-os.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://aurum-life-os.preview.emergentagent.com")
