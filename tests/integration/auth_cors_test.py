...
FOCUS AREAS:
1. OPTIONS preflight to /api/auth/login and /api/auth/me with Origin=https://supa-data-explained.preview.emergentagent.com
...
ORIGIN = "https://supa-data-explained.preview.emergentagent.com"
