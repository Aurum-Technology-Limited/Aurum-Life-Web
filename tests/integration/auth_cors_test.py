...
FOCUS AREAS:
1. OPTIONS preflight to /api/auth/login and /api/auth/me with Origin=https://smart-life-os.preview.emergentagent.com
...
ORIGIN = "https://smart-life-os.preview.emergentagent.com"
