...
def authenticate():
    ...
    try:
        response = requests.post(
            "https://focus-planner-3.preview.emergentagent.com/api/auth/login",
...
def test_weekly_review(token):
    ...
    try:
        response = requests.post(
            "https://focus-planner-3.preview.emergentagent.com/api/ai/weekly-review",
            json={},
            headers={
...
def get_or_create_project(token):
    ...
    try:
        ...
        response = requests.get(
            "https://focus-planner-3.preview.emergentagent.com/api/projects",
        ...
        areas_response = requests.get(
            "https://focus-planner-3.preview.emergentagent.com/api/areas",
            headers={"Authorization": f"Bearer {token}"}
        )
...
def test_obstacle_analysis(token):
    ...
    try:
        ...
        response = requests.post(
            "https://focus-planner-3.preview.emergentagent.com/api/ai/obstacle-analysis",
            json=request_data,
            headers={
                "Authorization": f"Bearer {token}",
                "Content-Type": "application/json"
