...
FOCUS AREAS:
1. OPTIONS preflight to /api/auth/login and /api/auth/me with Origin=https://taskpilot-2.preview.emergentagent.com
...
ORIGIN = "https://taskpilot-2.preview.emergentagent.com"
