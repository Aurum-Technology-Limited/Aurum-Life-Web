...
FOCUS AREAS:
1. OPTIONS preflight to /api/auth/login and /api/auth/me with Origin=https://prodforge-1.preview.emergentagent.com
...
ORIGIN = "https://prodforge-1.preview.emergentagent.com"
