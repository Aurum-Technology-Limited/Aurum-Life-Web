...
/**
 * Pillar Card component showing individual pillar progress
        ...
        <div className="pillar-areas mt-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            {pillar.subareas.map((subarea) => (
              <div 
                key={subarea.name} 
                className="p-2 rounded-lg border cursor-pointer hover:border-[#F4D03F]/30 transition" 
                style={{
      ...
      <div className="mt-4 pt-3 border-t" style={{borderColor: 'rgba(244,208,63,0.1)'}}>
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <button 
              className="text-[10px] px-2 py-1 rounded border hover:opacity-90" 
              style={{
