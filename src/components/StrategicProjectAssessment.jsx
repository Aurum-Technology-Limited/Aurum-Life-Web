...
/**
 * StrategicProjectAssessment Component
 * Displays projects organized by strategic impact (High/Medium/Low)
 * with health indicators, progress tracking, and resource allocation
 */
export function StrategicProjectAssessment() {
  // Project data - in a real app, this would come from props or context
  const projects = [
    {
      id: '1',
      name: 'Alchemy Site',
  ...
  return (
    <div 
      className="strategic-project-assessment rounded-2xl border p-5 mb-6" 
      style={{
