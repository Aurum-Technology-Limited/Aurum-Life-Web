...
/**
 * AdvancedAIInsights Component
 * Strategic AI intelligence with predictive analytics and decision support
 */
export function AdvancedAIInsights() {
  const [aiQuery, setAiQuery] = useState('');
  const [isLoading, setIsLoading] = useState(false);

  // AI Insights data - in a real app, this would come from props or context
  const insights = [
    {
      id: '1',
      type: 'recommendation',
  ...
  // Predictions data - in a real app, this would come from props or context
  const predictions = [
    {
      id: '1',
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div 
                    ...
                    style={{background: 'rgba(11,13,20,0.4)'}}
                  >
                    <div 
