  ...
  return (
    <header 
      ...
      style={{
        ...
        borderColor: 'rgba(244,208,63,0.12)'
      }}
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <button 
            className="hidden md:inline-flex items-center gap-2 text-xs font-medium px-3 py-2 rounded-lg border transition hover:opacity-90" 
            style={{
