 ...
 * Strategic task management with alignment visibility and advanced filtering
 */
export function TasksSection() {
  ...
  // Task data - in a real app, this would come from props or context
  const tasks = [
    {
      id: '1',
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <div className="flex items-center gap-1 text-xs">
                    <span 
                      ...
                      style={{borderColor: 'rgba(244,208,63,0.18)'}}
                    >
