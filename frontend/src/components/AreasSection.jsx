...
/**
 * AreasSection Component
 * Displays strategic focus areas within life pillars with project integration
 * and capacity planning
 */
export function AreasSection() {
  const [selectedArea, setSelectedArea] = useState(null);

  // Area data - in a real app, this would come from props or context
  const areas = [
    {
      id: '1',
      name: 'Training',
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button 
            size="sm" 
            variant="outline" 
            style={{borderColor: 'rgba(244,208,63,0.15)'}}
          >
