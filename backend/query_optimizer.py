...
class QueryOptimizer:
    ...
    def optimize_user_data_query(user_id: str) -> Dict[str, str]:
        ...
        essential_fields = {
            'pillars': 'id, user_id, name, description, color, icon, importance, sort_order, archived, created_at, updated_at',
            ...
            'user_profiles': 'id, email, username, first_name, last_name, has_completed_onboarding, created_at, updated_at'
        }
