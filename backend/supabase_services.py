...
class SupabaseUserService:
    ...
    async def update_user_profile(user_id: str, profile_data: Dict[str, Any], ip_address: str = None) -> Optional[Dict[str, Any]]:
        ...
        Uses last_username_change column in user_profiles table
        """
        try:
            ...
            if username_change:
                ...
                if current_username != username_change:
                    ...
                    # Set the username change timestamp in the profile data
    ...
    async def _ensure_user_exists_in_users_table(user_id: str):
        ...
        try:
            ...
            if create_response.data:
                ...
                logger.warning(f"⚠️ Failed to create user {user_id} in users table")
