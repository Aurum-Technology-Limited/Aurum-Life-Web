...
print("Backend URL: https://3c105990-8251-418b-add7-b761b0f7ecd6.preview.emergentagent.com")
print("API Base: https://3c105990-8251-418b-add7-b761b0f7ecd6.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://3c105990-8251-418b-add7-b761b0f7ecd6.preview.emergentagent.com")
