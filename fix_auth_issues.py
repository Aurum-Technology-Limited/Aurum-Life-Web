...
print("Backend URL: https://productivity-hub-23.preview.emergentagent.com")
print("API Base: https://productivity-hub-23.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://productivity-hub-23.preview.emergentagent.com")
