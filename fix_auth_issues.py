...
print("Backend URL: https://auth-wizard-2.preview.emergentagent.com")
print("API Base: https://auth-wizard-2.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://auth-wizard-2.preview.emergentagent.com")
