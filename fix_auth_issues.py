...
print("Backend URL: https://taskpilot-2.preview.emergentagent.com")
print("API Base: https://taskpilot-2.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://taskpilot-2.preview.emergentagent.com")
