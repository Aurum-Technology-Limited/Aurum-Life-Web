...
print("Backend URL: https://focus-planner-3.preview.emergentagent.com")
print("API Base: https://focus-planner-3.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://focus-planner-3.preview.emergentagent.com")
