...
print("Backend URL: https://hierarchy-enforcer.preview.emergentagent.com")
print("API Base: https://hierarchy-enforcer.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://hierarchy-enforcer.preview.emergentagent.com")
