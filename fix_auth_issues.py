...
print("Backend URL: https://hierarchy-master.preview.emergentagent.com")
print("API Base: https://hierarchy-master.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://hierarchy-master.preview.emergentagent.com")
