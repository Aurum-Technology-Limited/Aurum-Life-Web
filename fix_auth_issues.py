...
print("Backend URL: https://prodflow-auth.preview.emergentagent.com")
print("API Base: https://prodflow-auth.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://prodflow-auth.preview.emergentagent.com")
