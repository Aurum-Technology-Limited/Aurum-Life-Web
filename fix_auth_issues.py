...
print("Backend URL: https://prodforge-1.preview.emergentagent.com")
print("API Base: https://prodforge-1.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://prodforge-1.preview.emergentagent.com")
