...
print("Backend URL: https://2a9362a1-0858-4070-86b9-4648da4a94c4.preview.emergentagent.com")
print("API Base: https://2a9362a1-0858-4070-86b9-4648da4a94c4.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://2a9362a1-0858-4070-86b9-4648da4a94c4.preview.emergentagent.com")
