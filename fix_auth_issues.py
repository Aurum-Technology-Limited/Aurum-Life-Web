...
print("Backend URL: https://datahierarchy-app.preview.emergentagent.com")
print("API Base: https://datahierarchy-app.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://datahierarchy-app.preview.emergentagent.com")
