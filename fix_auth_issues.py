...
print("Backend URL: https://2cd28277-bdef-4a23-84f3-f1e19960e535.preview.emergentagent.com")
print("API Base: https://2cd28277-bdef-4a23-84f3-f1e19960e535.preview.emergentagent.com/api")
print()

print("📋 TEST STEPS:")
print("=" * 50)
print("1. Navigate to: https://2cd28277-bdef-4a23-84f3-f1e19960e535.preview.emergentagent.com")
